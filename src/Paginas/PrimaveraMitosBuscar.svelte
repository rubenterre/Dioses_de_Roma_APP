...
<div class="container">
    <div class="cardDioses">
        <img src="/img/tarjetas_buscar/Tarjeta_Mitos_Primavera.webp" alt="" width="100%">
    </div>
    <div class="row">
        <div class="col s12 TitularDioses">
            <div class="col s12" style="padding-left:0px">
                <em class="txtDioses">Mitos</em>
                <h1 class="titDioses">Mito de la Primavera</h1>
            </div>

        </div>
    </div>
    <p class="txtBuscar">
        Ulises u Odiseo era hijo de Laertes, rey de la isla de Ítaca, y de Anticlea, nieta de Hermes. Cuando llegó a la edad
        ...
        características, la astucia y una gran fuerza. </p>
    <div class="imagen">
        <img class="responsive-img" src="img/tarjetas_art/Ulises_1.webp" alt="Aquiles derrotando a Héctor">
        <p class="white-text"> <em>Odiseo atado al mástil de su barco tratando de vencer la atracción de las sirenas. Cuadro de Leon Belly Las sirenas (Museo de l'Hotel Sandelin, Saint Omer, Francia).</em></p>
    </div>


    <p class="txtBuscar">
        Él fue quien sugirió construir el caballo de madera, con el que
    ...
    <p class="txtBuscar_final">

        Tras manifestarse Ulises a su hijo Telémaco, este
